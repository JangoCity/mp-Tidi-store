  ...
  <section class="container">
    ...
    <section class="btn-wrapper">
      <button class="btn-confirm"
              ...
              @click="handleSaveClick">保存</button>
    </section>
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    async _fetchAddressData() {
      if (!this.addressId) {
        this.region = ['请选择地址']
        createAddressForm.name.value = null
        createAddressForm.phone.value = null
        createAddressForm.area.value = null
        createAddressForm.number.value = null
        return
      }
      ...
      try {
        ...
        createAddressType[this.addressType - 1].checked = true
